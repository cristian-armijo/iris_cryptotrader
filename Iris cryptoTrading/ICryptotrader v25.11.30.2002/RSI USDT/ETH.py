...
MIN_PRICE_CHANGE = 0.1  # Cambio mínimo 0.1% (ajustado para ETH)
STOP_LOSS_PCT = 0.02  # 2% Stop Loss

# Sistema de seguimiento
PREDICTION_LOG_FILE = 'prediction_tracking_eth_lstm.json'

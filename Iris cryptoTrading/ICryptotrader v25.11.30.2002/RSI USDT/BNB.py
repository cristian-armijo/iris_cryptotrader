...
MIN_PRICE_CHANGE = 0.1  # Cambio mínimo 0.1% (ajustado para BNB)
STOP_LOSS_PCT = 0.02  # 2% Stop Loss

# Sistema de seguimiento
PREDICTION_LOG_FILE = 'prediction_tracking_BNB_lstm.json'
MODEL_FILE = 'BNB_lstm_model.h5'
prediction_history = []
